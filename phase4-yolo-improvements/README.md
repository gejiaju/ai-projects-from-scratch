...
> "加注意力到底有没有用"。"面试必问：你做的改进，凭什么说有效？"——消融实验就是答案。
...
过拟合，注意力模块的优势在大数据集上才能体现。这个"负面结果"本身是诚实的科学结论，
面试时讲"我做了对照实验，发现加模块不等于一定有效"比吹牛更有说服力。
...
> 这个踩坑过程本身就是面试素材：说明你不是"照着教程跑"，而是真的读懂了 ultralytics
> 的模型加载机制，遇到问题能定位到源码级原因。
